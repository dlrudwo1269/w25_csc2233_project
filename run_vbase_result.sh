...
./run_vbase_experiment.sh --distribution zipfian_flat --selectivity 1
./run_vbase_experiment.sh --distribution zipfian_flat --selectivity 10
./run_vbase_experiment.sh --distribution zipfian_flat --selectivity 50
./run_vbase_experiment.sh --distribution zipfian_flat --selectivity 90
./run_vbase_experiment.sh --distribution zipfian_flat --selectivity 99